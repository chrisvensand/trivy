...
- Added a component-level docstring to describe the purpose of `CategoryGameComponent`.
- Added comments to explain the purpose of each state variable.
- Documented the effects to clarify when and why data is fetched.
