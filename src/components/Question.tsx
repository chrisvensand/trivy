 ...
 * @param {string[]} props.choices - An array of answer choices.
...
- Included inline comments to clarify the logic behind button color determination and state updates.